...
const Profile = () => {
    ...
    const username = win.getItem('name')
    const profilePhoto = win.getItem('photo')
  ...
  return (
    <div className='flex-grow h-screen pb-44 pt-6 xl:mr-40 overflow-y-auto scrollbar-hide'>
        <div className='relative h-[50%] w-[100%] lg:w-[80%] mx-auto mb-40'>
            <img src='image/download-color.jpg' alt="cover" className='h-[100%] w-[100%] object-fill' />
            ...
            <div className='absolute top-[90%] lg:top-[60%] xl:left-[40%]'>
                <div className=' h-[120px] w-[120px]  lg:w-[120px] xl:h-[210px] xl:w-[210px] rounded-full'>
                    <img src={profilePhoto} alt="profile" className='h-[120px] w-[120px] lg:h-[120px] lg:w-[120px] xl:h-[200px] xl:w-[200px] rounded-full object-cover cursor-pointer border border-white' />
                </div>
                ...
                <h2 style={{fontFamily: 'revert'}} className='text-2xl font-semibold pt-4 flex items-center justify-center'>{username}</h2>
            </div>
        </div>
